...
API_KEY = 'P58j5X8ebjSWZHcaq0FBdZLw'
SECRET_KEY = 'F7xTsPL9xiN0I5FL8AS8ApImWHOvTGlN'
...
def getVoice(_TEXT):
    ...
    save_file = "error.txt" if has_error else filename+"." + FORMAT
    with open("./static/"+save_file, 'wb') as of:
        of.write(result_str)
